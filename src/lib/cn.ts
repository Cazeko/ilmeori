...
const twMerge = extendTailwindMerge({
  extend: {
    classGroups: {
      "font-size": [
        {
          // h4(17px) 는 본문과 같은 값이라, body-lg(19px) 는 h3 와 같은 값이라
          // 없앴다. 이름 둘에 값 하나면 둘 다 뜻을 잃는다.
          // figure 는 화면당 하나 쓰는 큰 숫자다(globals.css 참조).
          text: ["body", "body-sm", "body-xs", "h1", "h2", "h3", "figure"],
        },
      ],
    },
  },
