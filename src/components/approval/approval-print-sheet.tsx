 ...
 * ── 왜 종이가 여전히 있는가 ────────────────────────────────────────────────
 *
 * HWPX 는 한/글에서 열리는 것을 실물로 확인했다. 그런데도 계획서 §5.3이 정한
 * 폴백은 **살아 있다** — 폴백은 「안 열릴까 봐」만이 아니라 「그 자리에 한/글이
 * 없을 수도 있어서」 있기 때문이다. 그래서 이 화면은 파일과 종이를 **둘 다**
 * 내놓는다. 심사에서 파일을 열 프로그램이 없으면 그 자리에서 Ctrl+P 로 답할
 * 수 있어야 한다.
 *
