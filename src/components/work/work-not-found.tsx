      ...
      <Card className="max-w-2xl">
        <CardBody className="py-8">
          ...
          {editable ? (
            <>
              ...
              <p className="mt-4 text-body-sm leading-relaxed break-keep text-gray-60">
                고쳐야 한다면 이 업무의 소유자에게 편집 권한을 요청하십시오.
                참여자·권한 탭에서 소유자가 누구인지 볼 수 있습니다.
              </p>
            </>
          ) : (
            <>
              ...
              <p className="mt-4 text-body-sm leading-relaxed break-keep text-gray-60">
                「권한이 없습니다」라고 답하면 그 업무가 존재한다는 사실을 알려
                주는 셈이 됩니다. 업무 제목 하나로 알 수 있는 것이 있고 — 어느
                부서에 무슨 감사가 걸려 있는지 같은 것 — 공문서를 다루는
                시스템에서는 존재 여부 자체가 지켜야 할 정보입니다.
              </p>
              ...
              <p className="mt-4 text-body-sm leading-relaxed break-keep text-gray-60">
                {isSupabaseConfigured ? (
                  <>
                    ...
                    보안(RLS)이 애초에 행을 내어 주지 않아, 서버조차 둘을 구분할
                    방법이 없습니다. 서버를 우회해 직접 질의해도 결과는 같습니다.
                  </>
                ) : (
                  <>
                    지금은 DB 없이 도는 시연 모드라, 서버가 같은 규칙을 흉내 내고
                    있습니다. 데이터베이스에 연결하면 이 판단을 행 수준 보안(RLS)이
                    하고, 서버조차 없는 것과 못 보는 것을 구분할 수 없게 됩니다.
                  </>
                )}
              </p>
            </>
          ...
          <div className="mt-6 flex flex-wrap gap-2">
            <ButtonLink href="/works" variant="primary" size="sm">
              업무 보드로
            </ButtonLink>
